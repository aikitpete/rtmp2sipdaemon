 ...
 *
 * @brief
 * Contain CRtmpMessage class for store information about message header.
 */

#ifndef CRTMPMESSAGE_H
#define CRTMPMESSAGE_H
...
class CRtmpMessage
{
    ...
    public:
         ...
         *
         * @param msgType
         * Message type from CRtmpMessage::MsgType enum.
         *
         * @return
         * Returns boolean value indicate result of opreation.
         *
         * @see
         * CRtmpMessage::MsgType
         */
         ...
         *
         * @return
         * Returns CRtmpMessage::MsgType value represents type of the message.
         *
         * @see
         * CRtmpMessage::MsgType
         *
        ...
        bool ReadChunk(CRtmpChunk chunk);
        bool PushToPayload(std::string strPayload);
        std::string PopPayload();
        int GetLoadedPayloadLen() const;
